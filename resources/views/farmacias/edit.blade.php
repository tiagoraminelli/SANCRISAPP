        ...
        <div class="flex items-start justify-between">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 mt-1 uppercase tracking-wider font-mono">
                    [ Modificación de farmacia de turno ]
                </p>
            </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <span class="text-xs text-gray-400">Complete el formulario para modificar la farmacia</span>
                </div>
                    ...
                    <div class="flex flex-wrap border border-gray-200 rounded-xl overflow-hidden shadow-inner">
                        ...
                        <div class="w-full lg:w-3/5 p-6 border-r border-gray-200 bg-white space-y-5">
                            <div>
                                ...
                                <input type="text" name="nombre" value="{{ old('nombre', $farmacia->nombre) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="direccion"
                                    value="{{ old('direccion', $farmacia->direccion) }}" placeholder="Calle y número"
                                    class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                @error('direccion')
                                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="telefono"
                                        value="{{ old('telefono', $farmacia->telefono) }}" placeholder="351 123-4567"
                                        class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                    @error('telefono')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2 items-center">
                                        <input type="time" name="horario_apertura"
                                            value="{{ old('horario_apertura', $farmacia->horario_apertura ? \Carbon\Carbon::parse($farmacia->horario_apertura)->format('H:i') : '') }}"
                                            class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                        <span class="text-gray-400">-</span>
                                        <input type="time" name="horario_cierre"
                                            value="{{ old('horario_cierre', $farmacia->horario_cierre ? \Carbon\Carbon::parse($farmacia->horario_cierre)->format('H:i') : '') }}"
                                            class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                    </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="latitud"
                                        value="{{ old('latitud', $farmacia->latitud) }}" placeholder="-31.5375"
                                        class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                    @error('latitud')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" name="longitud"
                                        value="{{ old('longitud', $farmacia->longitud) }}" placeholder="-68.5367"
                                        class="w-full h-10 px-3 rounded-lg border-gray-200 text-sm focus:ring-black focus:border-black transition">
                                    @error('longitud')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="w-full lg:w-2/5 p-6 bg-gray-50/50 space-y-5">
                            <div>
                                ...
                                {{-- Vista previa del logo (más pequeño y responsive) --}}
                                <div class="mb-3 flex justify-center">
                                    <div class="relative">
                                        <div id="logo-container"
                                            class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden border border-gray-200 cursor-pointer hover:opacity-80 transition">

                                            <img id="logo-preview"
                                                src="{{ $farmacia->logo_url ?: 'https://via.placeholder.com/128?text=Sin+Logo' }}"
                                                alt="Logo de la farmacia" class="w-full h-full object-cover">
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="py-2">
                                        ...
                                        <p class="text-xs font-bold mt-2">Cambiar Logo</p>
                                        <p class="text-[10px] text-gray-400 mt-1 uppercase">PNG, JPG (MAX 2MB)</p>
                                        <p class="text-[10px] text-gray-400 mt-1">Dejar vacío para mantener el actual
                                        </p>
                                    </div>
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="4"
                                    ...
                                    placeholder="Información adicional sobre la farmacia...">{{ old('descripcion', $farmacia->descripcion) }}</textarea>
                                @error('descripcion')
                                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-gray-100 pt-6">
                        ...
                        <div class="flex items-center gap-3 bg-gray-50 px-4 py-2 rounded-xl border border-gray-100">
                            <input type="checkbox" name="activo" value="1"
                                {{ old('activo', $farmacia->activo) ? 'checked' : '' }}
